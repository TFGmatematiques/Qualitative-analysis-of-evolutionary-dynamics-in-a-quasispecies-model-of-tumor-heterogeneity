# -*- coding: utf-8 -*-
"""
Created on Mon Jun 22 12:51:38 2026
...
def d2_t(t, A):
    return d20 + rho * A * np.sin(omega * t)
...
def f2(x1, x2, t, r2, A):
    N = x1 + x2
    return r2 * (1 - N / K) - d2_t(t, A)

def camp(t, X, r1, r2, A):
    x1, x2 = X

    f1_val = f1(x1, x2, t, r1, A)
    f2_val = f2(x1, x2, t, r2, A)
...
for ax, (nom_cas, params) in zip(axs, casos.items()):
    ...
    print("d20 =", d20)
    print("rho =", rho)
    print("Delta_f0 = (r1 - d10) - (r2 - d20) =", Delta_f0)
    print("======================================")
...
plt.legend(fontsize=15, loc="center", bbox_to_anchor=(0.9, 0.35))
plt.grid(False)
plt.tight_layout()
plt.show()